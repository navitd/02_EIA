...
statcan_activity_dict = dict(zip(statcan_rough['ACTIVITY'], statcan_rough['Economic activity']))
...
temp = statcan[(statcan["TIME_PERIOD"] ==int(year)) & (statcan["Transaction"] == 'Intermediate consumption')].drop(columns=['TIME_PERIOD','Transaction'])

# statcan_rough['Economic activity'].unique()
#'Activities of households as employers of domestic personnel',
# statcan_rough.ACTIVITY
