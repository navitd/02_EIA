...
for country in countries:
    ...
    model = pm.auto_arima(
        ...
        d=d,                 # let model decide via ADF test
        seasonal=False,
...
# ARIMA gives a slope for japan that is negative and the gdp goes under zero for 2040
# make a linear extrapolation for japan starting from the value in 2023
# going down with a = 
