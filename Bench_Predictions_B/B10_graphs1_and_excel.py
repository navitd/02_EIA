...
if 0:
    ...
    name = 'output'
    ICT = 'ICT'
    package_print_shares_to_excel(xlsx_filename, worksheet_name,dfGDP, output_shares, ICT_output_shares, output_ICT_share_category, name, ICT, highlighted, ICT_factors)
