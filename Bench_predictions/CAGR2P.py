...
#from func_plot_CAGR1 import plot_CAGR1_sum_sectors there is a CAGR plot function in Benchmarking - took it out of the EIAfunctions folder
...
for country in countries:
    ...
    for year in year_range:
        ...
        final_demand_columns = ['HFCE',	'NPISH',	'GGFC',	'GFCF',	'INVNT',	'CONS_NONRES', 'DPABR'] # 'IMPO', 'EXPO'
